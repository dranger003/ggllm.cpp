...
struct ggml_tensor * forward_batch_wo_cache_flash_attn_train(
    ...
    for (int il = 0; il < n_layer; ++il) {
        ...
        use_buf(-1); struct ggml_tensor * t07 = expand(gf, ggml_rope_inplace (ctx0, t06, n_past, n_rot, rope_mode, n_batch));          assert_shape_4d(t07, n_embd/n_head, n_head, N, n_batch);
        ...
        use_buf(-1); struct ggml_tensor * t10 = expand(gf, ggml_rope_inplace (ctx0, t09, n_past, n_rot, rope_mode,n_batch));          assert_shape_4d(t10, n_embd/n_head, n_head, N, n_batch);
